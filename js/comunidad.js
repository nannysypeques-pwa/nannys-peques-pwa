...
const Comunidad = {
            ...
            noticiasCliente: [
                {
                    ...
                    content: "Aprovecha nuestras promociones en servicios de lunes a viernes con 10% de descuento desde servicios de 6 horas al día.",
                    tipo: "Promo",
     ...
     */
    render: function () {
        const container = document.getElementById('vista-com') || document.getElementById('vista-comunidad');
        if (!container) return;
